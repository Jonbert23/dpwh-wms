...
class HrContractController extends Controller
{
    public function index()
    {
       ...
       foreach($contract as $contracts)
       {
        ...
        return view('hr.contract.ContractIndex', compact('worker','contract','count','all','new','expire'));
    }
    ...
    public function registerContract()
    {
       ...
       return view('hr.contract.RegisterContract', compact('worker','contract'));
    }
    ...
    public function createContract($id)
    {
        ...
        return view('hr.contract.ContractCreat', compact('worker','contract','lastD','lastS','lastE'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $activity = "Registered contract for".$fname." ".$lname;
    ...
    public function editContract($workerId,$contractId)
    {
        ...
        return view('hr.contract.ContractEdit',compact('contract','worker','contractphoto'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $contract->save();
         ...
         $fname = Worker::find($workerId)->firstName;
         $lname = Worker::find($workerId)->lastName;
         $activity = "Updated contract of ".$fname." ".$lname;
         $logDate = Carbon::now('Asia/Manila');
    ...
    public function show($id)
    {
        ...
        return view('hr.contract.ContractView',compact('worker','contract','now','conPhoto'));
    }
