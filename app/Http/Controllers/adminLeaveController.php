...
class adminLeaveController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.leave.laeveIndex',compact('worker','leaveWorker'));
    }
    ...
    public function grantLeave()
    {
        ...
        return view('admin.leave.leaveCreate',compact('lc','worker','dateNow','temp','from','to','remaining','lcId'));
    }
