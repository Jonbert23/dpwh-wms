...
class HrAttendanceController extends Controller
{
    ...
    public function uploadAttendace()
    {
        ...
        $yearNow = $now->year;
        $monthNow  = $now->month;
        return view('hr.attendance.UploadAttendance',compact('worker', 'yearNow','monthNow'));
    }

    public function DTRIndex()
    {
        $worker = Worker::all();
        return view('hr.attendance.DTRIndex', compact('worker'));
    }
    ...
    public function showDTR($id)
    {
        ...
        return view('hr.attendance.DTR', compact('worker','month','yearNow','searchYear','searchMonth'));
    ...
    public function searhDTR(Request $request)
    {
        ...
        return view('hr.attendance.SearchDTR', compact('attendance','start','end','worker','month','year','yearNow','monthNow','verifier','OT','otVerifier','endLoop','otEmpty'));
    }
    ...
    public function storeAttendance(Request $request)
    {
        ...
        fclose($fileToRead);
         ...
         //logs---------------------------------------------------------------------------------------------------------------------------------------------------------
         $activity = "Upload Attendance Log File";
