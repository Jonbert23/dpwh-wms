...
class HrWorkerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('hr.worker.index',compact('worker','labor','admin','mpp'));
    }
    ...
    public function create()
    {
        ...
        return view('hr.worker.create', compact('role','skill','section','education'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($role == 3)
        {
            ...
            //logs---------------------------------------------------------------------------------------------------------------------------------------------------------
            $fname = Worker::find($workerId)->firstName;
            $lname = Worker::find($workerId)->lastName;
            $activity = "Registered ".$fname." ".$lname;
    ...
    public function edit($id)
    {
        ...
        return view('hr.worker.edit', compact('worker','skill','section','education','role','mySalary','myCredit','myDeductionPagibig','myDeductionGsis','myDeductionPhilHealth','leaveStart','leaveEnd','w_address','deductionStatus'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $activity = "Update ".$fname." ".$lname." acount";
        $logDate = Carbon::now('Asia/Manila');
    ...
    public function view()
    {
        ...
        $picture = "img/Worker ID"."/".$findWorker->idPicture;
        return view('hr.worker.view', compact('findWorker','picture','contract','workerAdd','dateNow','salary','deduction','leave'));
    }
