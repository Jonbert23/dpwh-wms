  ...
  <div class="loading"><img src="{{asset('img/loading.gif')}}" alt="loading-img"></div>
    ...
    <div class="sidebar clearfix">
      <ul class="sidebar-panel nav">
        ...
        <li><a href="/mppProfile"><span class="icon color7"><i class="fa fa-user"></i></span>My Profile</a></li>
        <li><a href="/mppTask"><span class="icon color5"><i class="fa fa-calendar"></i></span>My Task</a></li>
        <li><a href="/mppSupervisory"><span class="icon color5"><i class="fa fa-users"></i></span>My Supervisory</a></li>
