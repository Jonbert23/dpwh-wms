        ...
        <div class="panel panel-default">
            ...
            <div>
                <div class="panel-body">
                    <form class="form-inline" action="/searchSalary" method="POST">
                        {{@csrf_field()}}
              ...
              <tbody>
                  ...
                  @for($i = 1; $i <= 31; $i++)
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{(int)($total_hour / 60)}} Hour</td>
                        <td class="text-center">{{$total_hour % 60}} Minutes</td>
                        <td>P {{$total_hour * ($salAmount/480)}}</td>
                        <?php $total_total = $total_total + ($total_hour * ($salAmount/480));?>
                    </tr>
                    <?php $total_hour = 0;?>
                @endfor
                <tr>
                    <td class="text-center">Total Salary</td>
                    <td colspan="3">{{$total_total}}</td>
                </tr>
