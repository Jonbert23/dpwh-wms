          ...
          <div class="panel-body">
            ...
            <table class="table table-bordered table-striped" >
                ...
                <tbody class="text-capitalize">
                    ...
                    <?php $no++;?>
                        @if(\Carbon\Carbon::createFromFormat('Y-m-d',$cons->startingDate)->month <= $monthNow && \Carbon\Carbon::createFromFormat('Y-m-d',$cons->expiryDate)->month >= $monthNow)
                            @if(\Carbon\Carbon::createFromFormat('Y-m-d',$cons->startingDate)->year == $yearNow && \Carbon\Carbon::createFromFormat('Y-m-d',$cons->expiryDate)->year == $yearNow)
                                <tr>
                                    <td>{{$no}}</td>
