        ...
        <div class="panel panel-default">
            ...
            <div>
                <div class="panel-body">
                    <form class="form-inline" action="/adminSalaryReportSearch" method="POST">
                        {{@csrf_field()}}
            ...
            <div class="row">
                <div class="col-md-12">
                    <p style="font-size: 14px; text-indent: 50px;">
                        <b>I CERTIFY</b> on my honor that the above is true and correct report of employees contract status/remark - a record of which from office using the district's Workers Management System.
                    </p>
                </div>
            </div>
            <br>
