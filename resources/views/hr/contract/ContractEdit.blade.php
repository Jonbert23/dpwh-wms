    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="form-horizontal" action="/hrUpdateContractPhoto" method="POST" enctype="multipart/form-data">
            {{@csrf_field()}}
      ...
      <div class="panel-title panel-info">
        Contract Registration Form
          ...
          <div class="panel-body">
            <form class="form-horizontal" action="/hrContract/{{$contract->id}}" method="POST">
                {{@csrf_field()}}
                {{@methoD_field('PUT')}}
