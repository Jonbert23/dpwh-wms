  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" action="/hrSearchDTR" method="POST">
          {{@csrf_field()}}
    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-title">
          Upload biometric log file form
        </div>
            <div class="panel-body">
              <form class="form-inline" action="/hrStoreAttedance" method="POST"  enctype="multipart/form-data">
                {{@csrf_field() }}
                <div class="col-md-9">
                    <input type="file"  id="real-file"  name="attendanceUpload" style="display:none"/>
                    <button type="button" class="btn btn-success"id="custom-button"> <i class="fa fa-upload"> Upload Biometric Log File </i> </button>
